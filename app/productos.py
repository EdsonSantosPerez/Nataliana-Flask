...
@productos.route('/registrarProducto')
@login_required
def registrarProducto():
    ...
    return render_template('/registrarProducto.html', form = registerProducto, **context)

@productos.route('/registrarProducto', methods=['POST'])
@login_required
def registrarProducto_post():
